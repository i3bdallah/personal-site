...
# To enable, copy your resume/CV to `static/files/cv.pdf` and uncomment the lines below.
  - icon: cv
    icon_pack: ai
    link: static\uploads\ABDULLAH_KASSAS_RESUME.pdf
...
{{< icon name="download" pack="fas" >}} {{< staticref "uploads/ABDULLAH_KASSAS_RESUME.pdf" "newtab" >}}Download{{< /staticref >}} my resumé as a PDF.
